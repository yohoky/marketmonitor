...
**Windows 桌面常驻的 A 股 / 港股 悬浮小组件** —— 多股同屏、实时行情、异动提醒，背景 / 文字透明度分别可调、黑白摸鱼模式、位置尺寸全部可调，右键即配置，装完即用。

**v1.4.3 · MIT License · 无需账号 · 免费无 Key**
...
- 已支持 **A 股 / 基金(ETF) / 可转债 / 港股**；北交所（4 / 8 开头）仍需手动加 `sh/sz` 前缀
